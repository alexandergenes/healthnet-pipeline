...
**Plataforma — Microsoft Azure + Databricks**  
Azure fue seleccionado por la integración nativa entre ADLS Gen2, Databricks y ADF, que permite implementar una arquitectura Medallion completa con Delta Lake, Unity Catalog y Change Data Feed sin fricciones.
